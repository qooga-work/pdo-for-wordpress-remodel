<?php
/*
Plugin Name: PDO For Wordpress 2.6.1 Remodel
Plugin URI: https://qooga.jb-jk.net/pdo-for-wordpress-remodel/
Description: PDO SQLite使用プラグイン『<a href="https://wordpress.org/plugins/pdo-for-wordpress/" target="_blank">pdo-for-wordpress</a>Version2.6.1(<a href="rathercurious.net" target="_blank">Justin Adie</a>作)』ベースに、改造したもの。使わなくなってから公式で2.7.0が出ていた。
Version: 1.0.0
Author: Justin Adie(rathercurious.net) >> Modification is QoogaKIKAKU (T.O) 
Author URI: https://qooga.jb-jk.net
License: https://github.com/qooga-work/pdo-for-wordpress-remodel/blob/master/LICENSE
*/
